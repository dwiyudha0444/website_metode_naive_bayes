                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav nav-pills mx-auto nav-style1" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation"><a class="nav-link nav-menu active"
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link nav-menu" id="pills-contact-tab" data-toggle="pill"
                                    href="#pills-contact" role="tab" aria-controls="pills-contact"
                                    aria-selected="false">Contact</a>
                            </li>
                        </ul>
                    </div>
                    <button class="head-contact-us">Login</button>
                                    ...
                                    <div class="counter-style1">
                                        ...
                                        <div class="countdown-timer" id="countdown-boxes">
                                            <ul class="list-inline count-down-list text-center">
                                                <li id="years"><span class="years">900</span><span
                                                        class="counter-time-title">Years</span></li>
                                                <li id="months"><span class="months">12</span><span
                                                        class="counter-time-title">Months</span></li>
                                                <li id="days"><span class="days">30</span><span
                                                        class="counter-time-title">Days</span></li>
                                                <li id="hours"><span class="hours">24</span><span
                                                        class="counter-time-title">Hours</span></li>
                                                <li id="minutes"><span class="minutes">50</span><span
                                                        class="counter-time-title">Minutes</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="content-text">
                                    ...
                                    <p class="second-pera">
                                        ...
                                        com modo consequat. Duis aute irure
                                    ...
                                    <div class="contact-btn">
                                        <button type="button" class="btn btn-primary btn-sm">Contact Us <i
